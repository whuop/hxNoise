...
class Perlin
{
	...
	private static var PERMUTATIONS = [151,160,137,91,90,15,                 
    ...
    private static var P : haxe.ds.Vector<Int>;
	...
	{
		num++;
		// TODO: Repeat things here
		return num;
	}

	public function grad(hash : Int, x : Float, y : Float, z : Float)
	{
		switch(hash & 0xF)
		{
			case 0x0: return x+y;
